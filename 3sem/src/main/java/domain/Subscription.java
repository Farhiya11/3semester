...
public class Subscription {
    public static void main(String[] args) {
        try 
        {
            ...
            List<UaMonitoredItem> items = subscription.createMonitoredItems(TimestampsToReturn.Both, Arrays.asList(request), (UaSubscription.ItemCreationCallback) onItemCreated).get();
